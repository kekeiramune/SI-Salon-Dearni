...
reservasi_bp = Blueprint('reservasi_bp', __name__, url_prefix='/reservasi')

# Tampil semua reservasi
@reservasi_bp.route('/')
def manage_reservasi():
    ...
    return render_template('reservasi.html', reservasi=reservasi_list, customer=customer_list, layanan=layanan_list,
        id_layanan_selected=id_layanan_selected)

@reservasi_bp.route('/edit/<int:id_reservasi>', methods=['GET'])
...
@reservasi_bp.route('/edit/<int:id_reservasi>', methods=['POST'])

...
def get_detail_by_restock(id_detail_restock):
...
def insert_detail(id_detail_restock, id_produk, jumlah, harga_satuan):
    cursor = mysql.connection.cursor()
    cursor.execute("""
        INSERT INTO detail_restock (id_restock, id_produk, jumlah, harga_satuan)
        VALUES (%s, %s, %s, %s)
    """, (id_detail_restock, id_produk, jumlah, harga_satuan))
